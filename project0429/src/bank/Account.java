...
//계좌를 정의해본다
//자바는 클래스간 서로 사용이 가능하므로 보안상 뜻하지 않았던 문제가
//발생할 수 있기 때문에 이를 보완하기 위해 접근제한자는 보안처리를 지원한다.
//자바의 보안 처리는 다음과 같이 총 4단계로 분류된다.
/*
 (공개)           상속관계, 같은 패키지   같은 패키지        나만 접근가능
public      <       protected       < default    <     private
(오른쪽으로 갈수록 보안이 강하다)
*/
public class Account{
	public String bankName="기업은행";
	public String master="배트맨";
	private int balance=5000; //멤버 메서드만 이 변수를 접근 가능
	public String num="084-45678-01";

	//데이터에 대한 직접 접근을 막았으나 선의의 사용자도 사용하지 못하게 되었으므로
